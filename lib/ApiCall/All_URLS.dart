...
const String urlForTopBarCategories =
    BaseURL + "wp-json/wp/v2/categories?per_page=100&hide_empty=true";
const String urlForMenu = BaseURL + "wp-json/wp/v2/menu";
const String urlForTopBarSubCategories = BaseURL +
    "wp-json/wp/v2/categories?per_page=100&order=desc&hide_empty=true&parent=";
...
class DatabaseHelper {
  static getAllData() async {
    await http
      ...
      Global.mainDataList = (Storedataoflist as List)
          .map((data) => MainCatModel.fromJson(data))
          .toList();
