  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Container(color: staticDarkblue,child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(title??"",style: TextStyle(color: Colors.white,fontSize: MediaQuery.of(context).size.width*0.05,fontWeight: FontWeight.bold),),
            ),),
            Spacer(),
            GestureDetector(
            onTap: (){
            ...
            ,child: Text('Read More'??"",style: TextStyle(color: Colors.black,fontSize: MediaQuery.of(context).size.width*0.04,fontWeight: FontWeight.bold),)),
            SizedBox(width: 20,),
          ],
        ),
